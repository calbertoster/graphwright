...
//
// Vendored verbatim (unminified UMD bundle) for graphwright's `serve` command —
// see SPEC.md §10.3/§10.4 and THIRD_PARTY_NOTICES.md. Not published to npm as a
// dependency; graphwright has zero runtime dependencies (CLAUDE.md rule 1).
//
// ISC License
//
